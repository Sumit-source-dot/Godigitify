          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+11234567890" className="text-sm hover:text-white transition-colors">
                  +1 (123) 456-7890
                </a>
              </li>
              <li className="flex items-center">
                <FaEnvelope className="text-blue-400 mr-3" />
                <a href="mailto:info@servicepro.com" className="text-sm hover:text-white transition-colors">
                  info@servicepro.com
                </a>
              </li>
            </ul>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="md:w-1/2">
              <form className="flex">
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-r-lg hover:opacity-90 transition-opacity"
                >
                  Subscribe
                </button>
              </form>
